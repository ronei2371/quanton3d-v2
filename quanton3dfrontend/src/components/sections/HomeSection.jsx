      ...
      <section className="home-hero" aria-labelledby="home-title">
        ...
        <div className="home-hero-visual">
          <video
            ...
            poster="/images/foto_hero_site.png"
            autoPlay
            muted
            loop
            playsInline
            aria-hidden="true"
          />
          <img className="home-hero-video-fallback" src="/images/foto_hero_site.png" alt="Pessoa interagindo com uma impressora 3D em um estúdio de luz azul e roxa" />
        </div>
      </section>
