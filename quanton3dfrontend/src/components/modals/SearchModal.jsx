...
const SEARCH_INDEX = [
  ...
  // Resinas
  { type: "Resina", label: "PyroBlast", desc: "Uso Geral · alta fluidez, peças decorativas e protótipos", page: "catalogo", keywords: "pyroblast pyro uso geral fluida decorativa prototipo" },
  { type: "Resina", label: "Iron", desc: "Engenharia · alta resistência a impacto", page: "catalogo", keywords: "iron engenharia resistente impacto funcional abs" },
  { type: "Resina", label: "Poseidon", desc: "Uso Geral · lavável em água", page: "catalogo", keywords: "poseidon lavavel agua washable" },
  { type: "Resina", label: "Flexform", desc: "Engenharia · a mais flexível da linha", page: "catalogo", keywords: "flexform flexivel elastica borracha" },
  { type: "Resina", label: "Spin (SPIN+)", desc: "Miniaturas e peças grandes · detalhe com leve flexibilidade", page: "catalogo", keywords: "spin spin+ miniatura action figure rpg grande formato" },
  { type: "Resina", label: "70/30", desc: "Engenharia e miniaturas · resistência com leve flexibilidade", page: "catalogo", keywords: "70/30 7030 iron miniatura resistencia" },
  ...
  { type: "Resina", label: "Athom Washable", desc: "Odontologia · lavável em água (uso externo)", page: "catalogo", keywords: "athom washable lavavel agua odontologia" },
  // Guias
