...
const S = {
  ...
  title: { fontSize: "clamp(1.5rem, 3vw, 2rem)", fontWeight: 700, margin: "0 0 10px", color: "#eaf3ff", lineHeight: 1.2 },
  subtitle: { fontSize: "14px", color: "#9fb4c7", maxWidth: "700px", lineHeight: 1.6, margin: 0 },
  ...
  input: { width: "100%", height: "44px", borderRadius: "10px", border: "1px solid rgba(113,159,219,0.25)", background: "rgba(4,12,24,0.55)", color: "#eaf3ff", padding: "0 60px 0 12px", outline: "none", fontSize: "14px" },
  suffix: { position: "absolute", right: "10px", fontSize: "12px", color: "#9fb4c7", pointerEvents: "none", fontWeight: 700 },
  ...
  metricVal: { fontSize: "clamp(1.3rem, 2vw, 1.8rem)", fontWeight: 700, color: "#eaf3ff", margin: "0 0 3px", lineHeight: 1.1 },
  metricValHL: { color: "#8be9ff" },
  metricUnit: { fontSize: "11px", color: "#9fb4c7" },
