...
function App() {
  ...
  // TODO: reativar — popup de boas-vindas desligado temporariamente a pedido do cliente durante a revisão visual
  const [mostrarBoasVindas, setMostrarBoasVindas] = useState(false);
  const [mostrarPrivacidade, setMostrarPrivacidade] = useState(false);
  // TODO: reativar — popup de cadastro (coleta de dados do cliente) desligado temporariamente a pedido do cliente durante a revisão visual
